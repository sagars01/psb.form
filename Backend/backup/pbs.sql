...
INSERT INTO `map_key_to_psb` VALUES (14,1,'ASR-1','Yet to be answered','DEFd','processing'),(15,1,'ASR-10','Yet to be answered','xyzw','approved'),(16,4,'ASR-1','Yet to be answered','haram','processing'),(17,4,'ASR-10','answered','nini','processing');
...
INSERT INTO `psb` VALUES ('ASR-1','The system must monitor and record successful and unsuccessful login attempts','The system must monitor and record login attempts to assist with investigating an intrusion. If an attacker gains access to a NetApp product in the field, the Customer Security department needs to retrieve a list of when accounts logged in to identify compromised accounts.'),('ASR-10','kjhkjdsahfkjeshfi','fhvija vnvgeyoioihyuhveoiuo');
...
-- Dump completed on 2018-02-23  4:39:39
