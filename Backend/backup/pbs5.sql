...
INSERT INTO `Login` VALUES (1,'arijit','xyz',0,0,1),(2,'sohom','abc',0,1,0),(3,'sagar','def',1,0,0);
...
INSERT INTO `map_key_to_milestone` VALUES (24,1,1,'abcd'),(25,1,2,'NULL'),(26,1,3,'NULL'),(27,1,4,'NULL'),(28,1,5,'NULL'),(29,1,6,'NULL'),(30,1,7,'NULL'),(31,1,8,'NULL'),(32,1,9,'NULL'),(33,1,10,'yyyy'),(34,1,11,'madar'),(35,4,1,'abcd'),(36,4,2,'NULL'),(37,4,3,'NULL'),(38,4,4,'NULL'),(39,4,5,'NULL'),(40,4,6,'NULL'),(41,4,7,'NULL'),(42,4,8,'NULL'),(43,4,9,'NULL'),(44,4,10,'yyyy'),(45,4,11,'madar');
...
INSERT INTO `map_key_to_pre` VALUES (15,1,1,'xyzw'),(16,1,2,'NULL'),(17,1,3,'NULL'),(18,1,4,'NULL'),(19,1,5,'zzzzzz'),(20,4,1,'xyzw'),(21,4,2,'NULL'),(22,4,3,'NULL'),(23,4,4,'NULL'),(24,4,5,'zzzzzz');
...
INSERT INTO `map_key_to_psb` VALUES (14,1,'ASR-1','Yet to be answered','abcd'),(15,1,'ASR-10','Yet to be answered','xyzw'),(16,4,'ASR-1','Yet to be answered','haram'),(17,4,'ASR-10','answered','nini');
...
INSERT INTO `map_user_to_product` VALUES (1,1,1),(2,1,4),(3,2,5),(4,2,6),(5,2,7);
...
INSERT INTO `product` VALUES (1,'ONTAP'),(2,'WFA'),(3,'OCUM'),(4,'WFA API'),(9,'KITKAT');
...
INSERT INTO `version` VALUES (1,1,1,'dd','aa'),(4,1,2,'ddddd','aasssss'),(5,2,2,'NULL','NULL'),(6,2,3,'NULL','NULL'),(7,3,1,'NULL','NULL'),(8,3,4,'NULL','NULL'),(12,9,1,'NULL','NULL');
...
-- Dump completed on 2018-02-22 15:30:38
