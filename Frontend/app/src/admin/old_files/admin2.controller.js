app.controller("dashboardController" , function($scope , $http, $state, mainService) {
    ...
    $scope.downloadAttachment = function() {
        ...
        window.open('http://10.235.240.73:4000/downloadpsb', '_blank');
    }
...
app.controller("pocCtrl" , function($scope , $state , mainService){
    $scope.main = { 
        manager : [''] , 
        engineer : [''] , 
        sdl : ['']
...
app.controller("helpCtrl" , function($state , $scope , $rootScope , mainService, toaster) {
...
app.controller('psbViewCtrl' , function($scope , $state , $rootScope , mainService, toaster){
    ...
    $scope.getPsbFormData();
$scope.formActionAdmin = function(param) {
        var temp = [];
