...
function mainService($http, $q ) { 
    ...
    function _fileUploadService(file) {
        var fileFormData = new FormData();
            fileFormData.append('file', file);

            var deffered = $q.defer();
            $http.post("http://10.235.240.73:4000/uploader", fileFormData, {
    ...
    function _psbFormService(method , data) {
        ...
        function _psbDraft(method , data) {
        var deferred = $q.defer();
        if(method == 'GET') {
            $http.get("http://10.235.240.73:4000/draft")
            .then(function(response) {
                deferred.resolve(response.data)
            }).catch(function(reject){
                deferred.reject(reject)
        ...
        return deferred.promise
            ...
            $http({
                url:  "http://10.235.240.73:4000/draft",
                method: 'POST',
                data : data,
                cache : false
            })
